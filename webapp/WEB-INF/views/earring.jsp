...
<div class="item item2">
    <img style="height: 350px; width: 100%;" src="resources/projectImg/Rings/earring banner.webp" alt="">
    
</div>
     
        <div class="item item4">
          <div class="card" style="width: 100%;">
            <img style="height: 176px;" src="resources/projectImg/Rings/earring 1.jfif"  class="card-img-top" alt="..."><hr>
            <div class="card-body"> <p class="card-text">Elegant Classy Diamond EarringRings</p>
