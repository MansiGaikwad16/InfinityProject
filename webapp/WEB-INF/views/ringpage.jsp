...
.navbar{
   background-color: rgb(192, 178, 192)  ;
}
a{
...
<div class="item item2">
    <img style="height: 350px; width: 100%;" src="resources/projectImg/Rings/the-wedding-ring-with-ai-generated-free-photo.jpg" alt="">
     <h3 class="cen">Discover Your Dream Ring</h3>
        ...
        <div class="item item4">
          <div class="card" style="width: 100%;">
            <img src="resources/projectImg/Rings/ring3.jpg" class="card-img-top" alt="..."><hr>
