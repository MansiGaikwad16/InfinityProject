...
<div class="item item2">
    <img style="height: 350px; width: 100%;" src="resources/projectImg/Rings collection.jpg" alt="">
     <h3 class="cen">Discover Your Dream Ring</h3>
        ...
        <div class="item item4">
          <div class="card" style="width: 100%;">
            <img src="resources/projectImg/Rings/solitaire-heart-ring_1.webp" class="card-img-top" alt="..."><hr>
